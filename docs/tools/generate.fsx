...
let referenceBinaries = ["WPFTagControl.dll"]
// Web site location for the generated documentation
let website = "/WPFTagControl"

let githubLink = "http://github.com/2moveit/WPFTagControl"

// Specify more information about your project
let info =
  [ "project-name", "WPFTagControl"
    "project-author", "Kai Timmermann"
    "project-summary", "WPF control for tags/tokens"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/WPFTagControl" ]
